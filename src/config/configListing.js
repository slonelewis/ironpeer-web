...
export const listingFields = [
  ...
  // IronPeer: damage deposit is platform-standardized, not set per listing.
  // Removed from listing flow to reduce friction. Policy TBD before go-live.
  // {
  //   key: 'damageDeposit',
  //   scope: 'public',
  //   schemaType: 'long',
  ...
  //     isRequired: false,
  //     helpText: 'Refundable deposit charged at booking. Returned after inspection with no damage.',
  //   },
  // },
  // {
  //   "scope": "public",
